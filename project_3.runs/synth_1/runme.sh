...
HD_PWD='C:/Users/srish/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bch_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bch_top.tcl
