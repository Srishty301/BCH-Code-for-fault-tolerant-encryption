...
HD_PWD='C:/Users/srish/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bch_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bch_top.tcl -notrace
